...
\usecolortheme{seagull}  % Outer color themes. Alternatives: whale, seahorse, dolphin, default, beaver
...
\setbeamertemplate{frametitle} % set the title in the middle of the page
{   \begin{center}
        \insertframetitle
    \end{center}
}
...
\setbeamertemplate{navigation symbols}{} % Delete the navigations
...
\newcommand{\paper}[1]{({\footnotesize #1})}
