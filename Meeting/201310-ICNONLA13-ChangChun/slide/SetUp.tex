...
\usefonttheme[onlylarge]{structurebold} % Font themes. Alternatives:  default, serif, structurebold, structureitalicserif, structuresmallcapsserif
...
\usepackage{moreverb}
\usepackage{comment}
\usepackage{multimedia} % Insert movie
